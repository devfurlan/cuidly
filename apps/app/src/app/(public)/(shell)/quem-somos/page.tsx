...
export const metadata: Metadata = {
  title: 'Sobre a Cuidly - Plataforma de Babás Verificadas',
  description:
    'Conheça a Cuidly, plataforma onde babás se cadastram e famílias buscam por profissionais verificadas. Validação de identidade e antecedentes para mais segurança.',
};
...
const values = [
  {
    ...
    title: 'Missão',
    description:
      'Facilitar a busca por babás qualificadas, oferecendo segurança, tecnologia e preços acessíveis.',
  },
  {
    icon: PiHeartDuotone,
    title: 'Visão',
...
const differentials = [
  ...
  },
  {
    ...
    description:
      'Algoritmo que sugere babás compatíveis com o perfil da família',
  },
  {
    title: 'Preços Justos',
    description: 'Planos acessíveis para famílias e babás',
  },
  {
    title: 'Transparência Total',
    description: 'Sem taxas escondidas ou cobranças surpresa',
  },
  {
    title: 'Foco no Brasil',
    description: 'Plataforma 100% brasileira, feita para o mercado local',
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              Somos uma plataforma brasileira onde babás se cadastram e famílias
              buscam por profissionais qualificadas, com segurança, tecnologia e
              preços justos.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-4 text-base/7 text-gray-600">
              <p>
                A Cuidly nasceu da percepção de que encontrar babás confiáveis
                ainda era um processo difícil e incerto. Grupos de WhatsApp,
                indicações de conhecidos, buscas intermináveis... faltava uma
                solução moderna e segura.
              </p>
              <p>
                Criamos uma plataforma simples e direta: babás criam seus
                perfis, famílias buscam e filtram por quem melhor atende suas
                necessidades. Sem intermediação, sem burocracia.
              </p>
              <p>
                Para trazer mais segurança, oferecemos ferramentas como
                validação de identidade, verificação de antecedentes e um
                sistema de avaliações, para que famílias e babás possam se
                encontrar com mais confiança.
              </p>
            </div>
          </div>
        </div>
