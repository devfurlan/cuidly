...
const PROFILE_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Sim! Cadastre-se gratuitamente para ter acesso às avaliações completas, match score personalizado e mais informações detalhadas.',
  },
  {
        ...
        <div className="mb-8 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              A plataforma mais segura e confiável para conectar famílias e
              babás verificadas em todo o Brasil.
            </p>
          </div>
