...
// Re-export hourly rate from common options
// FAMILY_HOURLY_RATE_OPTIONS is an alias for backwards compatibility
import { HOURLY_RATE_OPTIONS } from './common-options';
export const FAMILY_HOURLY_RATE_OPTIONS = HOURLY_RATE_OPTIONS;
