...
// Schema base para features do plano
...
// Schema para atualizacao de plano
...
// Features labels para o formulario
export const FEATURE_LABELS: Record<string, { label: string; description: string }> = {
  viewProfiles: {
    label: 'Visualizar Perfis',
    description: 'Número de perfis que podem ser visualizados por mês (0 = ilimitado)',
  },
  startConversations: {
    label: 'Iniciar Conversas',
    description: 'Número de conversas que podem ser iniciadas por mês (0 = ilimitado)',
  },
  boostPerMonth: {
...
// Default features para novos planos
