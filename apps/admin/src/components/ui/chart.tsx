...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<'div'> & {
      active?: boolean;
      payload?: Array<{ name?: string; value?: number | string; dataKey?: string; payload?: Record<string, unknown>; color?: string; fill?: string }>;
      label?: string;
      hideLabel?: boolean;
      ...
      color?: string;
      valueFormatter?: (value: number | ValueType) => string;
    }
>(
  (
    {
