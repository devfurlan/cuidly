...
test.describe('Subscription: Nanny Upgrade Flow', () => {
  test('should open Pro upgrade modal when clicking Fazer Upgrade', async ({ context, page }) => {
  ...
  test('should show Pro benefits in upgrade modal', async ({ context, page }) => {
    await loginAsNanny(context, page);
    await page.goto('/app/assinatura');
  ...
  test('should show billing interval toggle (Mensal / Anual)', async ({ context, page }) => {
    await loginAsNanny(context, page);
    await page.goto('/app/assinatura');
  ...
  test('should show annual discount info', async ({ context, page }) => {
    ...
    await expect(
      page.getByText(/Economize/i).first(),
    ).toBeVisible();
  });
  ...
  test('should open checkout modal when clicking Assinar Pro', async ({ context, page }) => {
    await loginAsNanny(context, page);
    await page.goto('/app/assinatura');
