...
test.describe("Subscription: Family Upgrade Flow", () => {
  test("should open upgrade modal when clicking Fazer Upgrade", async ({
    context,
    page,
  }) => {
  ...
  test("should show Plus benefits in upgrade modal", async ({
    context,
    page,
  }) => {
    await loginAsFamily(context, page);
  ...
  test("should show trust message in upgrade modal", async ({
    context,
    page,
  }) => {
    await loginAsFamily(context, page);
  ...
  test("should open checkout modal when clicking Assinar Plus", async ({
    context,
    page,
  }) => {
    await loginAsFamily(context, page);
  ...
  test("should show billing interval options in checkout", async ({
    context,
    page,
  }) => {
    await loginAsFamily(context, page);
