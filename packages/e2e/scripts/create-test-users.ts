  ...
  const nannyData = {
    ...
    nannyForTrial: {
      ...
      extra: {
        ...
        gender: "FEMALE" as const,
        experienceYears: 3,
        aboutMe: "Olá! Sou a Julia, babá com 3 anos de experiência.",
        isProfilePublic: true,
        hourlyRate: 30,
        dailyRate: 180,
        monthlyRate: 2500,
        ...
        nannyTypes: ["FIXED"],
        contractRegimes: ["CLT"],
        hourlyRateRange: "FROM_21_TO_30",
        ageRangesExperience: ["BABY", "TODDLER"],
        strengths: ["PATIENT", "CREATIVE"],
        acceptedActivities: ["COOK_MEALS", "LIGHT_CLEANING"],
        certifications: ["FIRST_AID"],
        languages: ["PORTUGUESE_NATIVE"],
        careMethodology: "MONTESSORI",
        comfortableWithPets: "YES_ANY" as const,
        parentPresencePreference: "NO_PREFERENCE" as const,
        acceptsHolidayWork: "NO" as const,
      },
    },
  };
