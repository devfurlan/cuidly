/**
 * Child Schemas
 * Validation schemas for child-related data
 */

import { z } from 'zod';

// Status enum for child records
...
// Full Child schema (for API responses)
export const ChildSchema = z.object({
  id: z.number(),
  name: z.string().nullable().optional(),
  birthDate: z.string().datetime().nullable().optional(),
  gender: z.string().nullable().optional(),
  status: ChildStatusEnum.default('ACTIVE'),
...
// Form schema for creating/editing children (admin)
